        ...
        <div className="bg-white/80 backdrop-blur rounded-2xl shadow-sm border border-gray-200 p-8">
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-8">
            <div className="rounded-2xl border border-gray-200 bg-white p-6 flex flex-col">
              ...
              <a href="/signin" className="mt-4 inline-flex justify-center rounded-lg bg-blue-600 hover:bg-blue-700 text-white px-4 py-2">Apply now</a>
            </div>
            <div className="rounded-2xl border border-gray-200 bg-white p-6 flex flex-col">
              <div className="flex items-start justify-between gap-4 mb-3">
                <div>
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <a href="/faqs" className="text-blue-600 hover:text-blue-700">Read FAQs</a>
          </div>
        </div>
      </div>
    </section>
